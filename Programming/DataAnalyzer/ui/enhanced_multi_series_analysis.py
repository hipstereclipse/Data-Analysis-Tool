...
class EnhancedMultiSeriesAnalysisDialog:
...
def show_enhanced_multi_series_analysis(parent, series_configs: Dict[str, SeriesConfig], 
                                       loaded_files: Dict[str, FileData]):
    """Show the enhanced multi-series analysis dialog"""
    dialog = EnhancedMultiSeriesAnalysisDialog(parent, series_configs, loaded_files)
