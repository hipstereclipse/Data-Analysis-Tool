...
class ProjectRefactorer:
    ...
    def __init__(self, project_root: str):
        ...
        self.import_patterns = [
            ...
            # Class name updates
            (r"EnhancedSeriesDialog", "SeriesDialog"),
            (r"SmartSeriesDialog", "SeriesDialog"),
            (r"ModernAnnotationDialog", "AnnotationDialog"),
            (r"EnhancedMultiSeriesAnalysisDialog", "MultiSeriesAnalysisDialog"),
            (r"EnhancedPlotManager", "PlotManager"),
            
            # Function name updates
            (r"show_enhanced_series_dialog", "show_series_dialog"),
            (r"show_enhanced_multi_series_analysis", "show_multi_series_analysis"),
        ]
